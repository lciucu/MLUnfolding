...
\textbf{
\begin{huge}
Machine learning for jet energy unfolding \\ in the ttbar e-mu analysis
\end{huge}
}
...
\vspace{0.7cm}
\includegraphics[width=0.5\textwidth]{./plots/LogoATLAS.png}\\
\vspace{0.7cm}
\Large{\today}
...
\begin{figure}[htbp]
     \begin{minipage}{0.5\textwidth}
      \centering
      \includegraphics[width=0.6\columnwidth]{./plots/LogoUGeneva.jpg}
     \end{minipage}\hfill
     \begin{minipage}{0.5\textwidth}
      \centering
      \includegraphics[width=0.3\columnwidth]{./plots/LogoDESY.png}
     \end{minipage}
   \end{figure}
